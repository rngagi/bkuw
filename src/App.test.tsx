...
const snapshot: ProjectSnapshot = {
  ...
  exportSettings: {
    ...
    latex: { title: "Test", author: "", headwordWritingSystemId: "ws-1", pronunciationWritingSystemId: null, exampleWritingSystemId: "ws-1", collationLanguageTag: null, sectionMode: "auto", reverseIndex: "gloss", relatedEntries: "none", includeSenseImages: false, includeSemanticDomains: true, fontPresets: { "ws-1": "auto" } },
  },
  entrySortSettings: { version: 2, mode: "auto", source: "writingSystem", writingSystemId: "ws-1", alphabet: [] },
...
describe("App keyboard and delete workflow", () => {
  ...
  it("recovers a manual-mode project whose layout was never initialized", async () => {
    const manualSnapshot: ProjectSnapshot = {
      ...snapshot,
      entrySortSettings: { version: 2, mode: "manual", source: "writingSystem", writingSystemId: "ws-1", alphabet: ["a", "ng"] },
