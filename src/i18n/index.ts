  ...
  en: {
    translation: {
      ...
      entry: {
        ...
        addImage: "Add photo", removeImage: "Remove photo", processingImage: "Processing…",
      },
      settings: {
      ...
      sorting: {
        ...
        writingSystem: "Sort by writing system", mode: "Ordering mode", auto: "Automatic", manual: "Fully manual",
        ...
        overrideDisabled: "Section overrides are inactive while fully manual ordering is enabled.", overrideTitle: "Move this entry to another section?",
      ...
      export: {
        ...
        includeSenseImages: "Include sense photos", includeSenseImagesHelp: "Copies stored PNG photos into the LaTeX project and Overleaf ZIP.",
      ...
      error: {
        ...
        image_processing: "The photo could not be processed or saved.",
      },
    },
  },
  "zh-TW": {
    translation: {
      ...
      entry: {
        ...
        addImage: "新增相片", removeImage: "移除相片", processingImage: "處理中…",
      },
      settings: {
      ...
      sorting: {
        ...
        writingSystem: "排序使用的書寫系統", mode: "排序模式", auto: "自動", manual: "完全自訂",
        ...
        overrideDisabled: "啟用完全自訂排序時，詞條小標覆寫不會生效。", overrideTitle: "要把這個詞條移到其他小標嗎？",
      ...
      export: {
        ...
        includeSenseImages: "包含義項相片", includeSenseImagesHelp: "將保存的 PNG 相片複製到 LaTeX 專案與 Overleaf ZIP。",
